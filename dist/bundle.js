...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ newProject)\n/* harmony export */ });\n/* harmony import */ var _dom_elements__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom-elements */ \"./src/page-elements/dom-elements.js\");\n/* harmony import */ var _functions_project_factory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../functions/project-factory */ \"./src/functions/project-factory.js\");\n\n\n\n\nlet idCounter = 0;\n\nfunction newProjectId() {\n    idCounter += 1;\n}\n\nfunction deleteForm() {\n    const form = document.getElementById('new-project-form');\n    form.remove();\n}\n\nfunction createProjectDom() {\n    const mainProjectContainer = document.getElementById('project-container');\n    const projectNameInput = document.getElementById('projectName');\n\n    const newProjectContainer = (0,_dom_elements__WEBPACK_IMPORTED_MODULE_0__.createDiv)('project', `project${idCounter}-id`);\n    const project = (0,_dom_elements__WEBPACK_IMPORTED_MODULE_0__.createButton)(`${projectNameInput.value}`, 'project-main-btn');\n\n    project.id = `project${idCounter}`;\n    project.onclick = _functions_project_factory__WEBPACK_IMPORTED_MODULE_1__.addProjectToFactory;\n\n    mainProjectContainer.appendChild(newProjectContainer);\n    newProjectContainer.appendChild(project);\n\n    deleteForm();\n}\n\nfunction crateProjectInterface() {\n    const content = document.getElementById('content');\n    const form = (0,_dom_elements__WEBPACK_IMPORTED_MODULE_0__.createForm)('New-Project', '', 'GET', 'new-project-interface');\n    const input = (0,_dom_elements__WEBPACK_IMPORTED_MODULE_0__.createFullInput)('projectName', 'new-project-name-label', 'text', 'projectName', 'new-project-name-input', 'projectName');\n    const submitButton = (0,_dom_elements__WEBPACK_IMPORTED_MODULE_0__.createButton)('Submit', 'submit-btn');\n\n    form.id = 'new-project-form';\n\n    content.appendChild(form);\n    form.appendChild(input);\n    form.appendChild(submitButton);\n\n    submitButton.type = 'button';\n    submitButton.onclick = createProjectDom;\n}\n\nfunction newProject() {\n    const newProjectBtn = document.getElementById('new-project-btn');\n\n    newProjectBtn.addEventListener('click', () => {\n        crateProjectInterface();\n        newProjectId();\n    });\n}\n\n\n//# sourceURL=webpack://to-do-list/./src/page-elements/new-project.js?");
